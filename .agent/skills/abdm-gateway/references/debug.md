# Debug Gateway, sessions and the bridge registry

The codes this module can return, with the message and the operation that returns each.

## Errors

The Gateway, sessions and the bridge registry specification's examples return no error code yet. That is a gap in the specification, not a promise that this module cannot fail.
