...
This file is a snapshot. Re-download the whole folder from https://abdm-docs.dev.eka.care/skills/abdm-scan-and-pay/ when it is older than the work you are doing: this router and every file under references/ that it links to. Fetching this file alone leaves those links pointing at files you do not have.
...
## What you can do with Scan and pay

- Scan and pay, HIP side
- Scan and pay, PHR side
- Scan and pay details and version update
...
- Every endpoint, with its body fields and responses: /docs/hiecm/v3/api/scan-and-pay
