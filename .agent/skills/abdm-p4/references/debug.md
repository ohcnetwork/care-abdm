# Debug P4, health lockers

The codes this module can return, with the message and the operation that returns each.

## Errors

The P4, health lockers specification's examples return no error code yet. That is a gap in the specification, not a promise that this module cannot fail.
