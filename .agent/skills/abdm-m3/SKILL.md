...
This file is a snapshot. Re-download the whole folder from https://abdm-docs.dev.eka.care/skills/abdm-m3/ when it is older than the work you are doing: this router and every file under references/ that it links to. Fetching this file alone leaves those links pointing at files you do not have.
