...
| `ABDM-1406` | Invalid session status, Status should be TRANSFERRED, PARTIAL\_TRANSFERRED or FAILED                                                                          | Fix request    |
...
| `AS-1191` | Missing or invalid request ID header. Please ensure a valid REQUEST\_ID is provided.                                                                                        | Fix request    |
...
| `AS-1373` | Invalid Credentials. Make sure your API invocation call has a header: 'Authorization : Bearer ACCESS\_TOKEN' or 'Authorization : Basic ACCESS\_TOKEN' or 'apikey: API\_KEY' | Fix request    |
...
| `AS-1409` | Invalid session status, Status should be TRANSFERRED, PARTIAL\_TRANSFERRED or FAILED.                                                                                       | Fix request    |
