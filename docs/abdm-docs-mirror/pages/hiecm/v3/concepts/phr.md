...
Counter names arrive in the QR code: up to 20 alphanumeric characters, no special characters, examples OPD, OPD1, OPD cardio, IPD1, Pharmacy. A counter name cannot be the [HFR](/docs/hiecm/v3/getting-started/glossary#hfr) facility ID, the [HPID](/docs/hiecm/v3/getting-started/glossary#hpid), the HIP ID or the HIP name.
