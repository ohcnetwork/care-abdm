...
You demonstrate the [ABDM](/docs/hiecm/v3/getting-started/glossary#abdm) functionality you built to the integration team. This is the first of two demonstrations, and it opens the process rather than closing it.
