...
| B5 | 2026-09-09 | Resolved 2026-09-15 | Whether the bridge `url` may carry a path prefix was unstated. The sandbox accepted `https://care-abdm-sbx.rithviknishad.dev/api/abdm` and `gateway-list-bridge-services` returned it as the bridge URL. | `gateway-update-bridge-url` |
